 ...
 * @author user
 */
public class MaterialsIcon extends GlyphNode{
    
    private static final FontType font = FontType.font(Resource.class, "MaterialSymbolsOutlined.ttf", 20);
    
    private final StringProperty glyphName;
    private final DoubleProperty glyphSize;
    public MaterialsIcon()
    {
        super(font, ".notdef");
